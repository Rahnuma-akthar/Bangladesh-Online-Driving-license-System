...
$getApplicants = $training->getApplicantAssign();
...
?>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-row-padding w3-margin-bottom">
            <h1>Assign Applicants for Training</h1>
            ...
            <table id="myTable" class="w3-table w3-border">
                ...
                <?php
                while($row = mysqli_fetch_assoc($getApplicants)){
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="../process-training.php" method="post">
                                ...
                                <input type="hidden" name="trainingSeries" value="<?=$row['payment_for']?>">
                                <input type="hidden" name="transactionNumber" value="<?=$row['transaction_number']?>">
                                <input type="submit" name="AssignforTraining" value="Assign for Training">
                            </form>
                        </td>
                    </tr>
                <?php    }
